...
1. Переходим на главное в окно *Консоль*, выбрав нужный корпус в окне *Консоль* находим номер к которому необходимо заблокировать доступ.

<img width="1506" height="950" alt="image" src="https://github.com/user-attachments/assets/45690765-c494-43b4-a1f3-9bac886d95ce" />

2. Левой кнопкой мыши (далее ЛКМ) кликаем на область найденного номера. Открылся выпадающий список, в нем находим пункт *Разрешение на доступ* и кликаем по нему ЛКМ.
...
5. Кликаем ЛКМ по ссылке *Удаленный отчет об утере*
   ...
   > После чего откроется окно где замкам передастся сообщение об утерянной карте. :white_check_mark: – отчет отправлен успешно. :x: – ошибка при отправке отчета.

<img width="636" height="475" alt="image" src="https://github.com/user-attachments/assets/192ea5b6-4770-4088-8e34-5cb0bf204ec1" />

> [!NOTE]
> Если удаленный отчет об утере выдал ошибку то необходимо сообщить замку напрямую используя приложение TTHotel на рабочем телефоне находясь при этом рядом с замком.(см. раздел мобильное приложение Android)[^2]
[^2]: Этот раздел не добавлен в примеры, так как скриншоты содержат личную информацию о сотрудниках, ее попросили не добавлять
